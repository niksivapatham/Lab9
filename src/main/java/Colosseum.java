...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (defense < 1 || defense > maxDef) {
            System.out.println("Sorry. The defense level must be between (1-" + maxDef + "): ");
            defense = scan.nextInt();
        }
